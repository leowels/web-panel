...
async def generate_act_content(
    ...
    try:
        ...
        prompt = f"""Создай КРАТКИЙ и четкий текст предписания (акта) Ростехнадзора:
...
- Официальный стиль Ростехнадзора
- Ссылки на ФНП 461/ГОСТ только если релевантны
- Максимум 5-7 абзацев"""
        
        system_prompt = "Ты помощник для создания официальных документов Ростехнадзора. Пиши КРАТКО, четко, структурированно. Только суть, без воды. Используй документацию только для релевантных ссылок."
