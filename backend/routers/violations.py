...
ЗАДАЧА:
1. Создай ОФИЦИАЛЬНОЕ, ДОКУМЕНТАЛЬНОЕ описание нарушения в стиле Ростехнадзора (2-4 предложения)
...
- Используй терминологию Ростехнадзора
...
- Срок устранения: критичные - 7 дней, высокие - 15 дней, средние - 30 дней, низкие - 60 дней"""
        ...
        system_prompt = "Ты помощник для создания официальных нарушений в системе Ростехнадзора. Твоя задача - оформить тип нарушения в официальный документ с указанием пунктов ФНП 461, ГОСТ и срока устранения. Отвечай строго в указанном формате."
