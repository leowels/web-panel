...
# Принудительно выводим в stdout/stderr
exec 1>&1
exec 2>&2

echo "=========================================="
echo "=== DOCKER ENTRYPOINT ЗАПУЩЕН ==="
echo "=== $(date) ==="
echo "=========================================="
...
ps aux | grep -E "(python|uvicorn)" | grep -v grep || echo "Процессы Python не найдены"
